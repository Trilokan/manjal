...
class Student(models.Model):
    ...
    student_uid = fields.Char(string="Patient ID", readonly=True)
    ...
    identity_ids = fields.One2many(comodel_name="arc.identity", inverse_name="student_id")
    ...
    family_member_ids = fields.One2many(comodel_name="arc.address", inverse_name="student_id")

    # School Details
    doj = fields.Date(string="Date of Joining", required=True)
    date_of_transfer = fields.Date(string="Date of Transfer")
    qualification_ids = fields.One2many(comodel_name="arc.qualification", inverse_name="student_id")
    ...
    def update_person_address(self):
        ...
        recs["name"] = self.name
        recs["person_uid"] = self.student_uid
    ...
    def create(self, vals):
        ...
        vals["student_uid"] = data["person_uid"]
